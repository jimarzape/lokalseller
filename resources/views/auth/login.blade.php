...
<body class="bg-2">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal form-material" id="loginform" action="{{ route('login') }}" method="POST">
                                ...
                                <div class="form-group ">
                                    <div class="col-xs-12">
                                        <input id="email" type="email" class="padding-10 form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <input id="password" type="password" class="padding-10 form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
    ...
    <script src="/dark/plugins/bootstrap/js/popper.min.js"></script>
