...
<div class="container-fluid">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover earning-box">
                            ...
                            <tbody>
                                <tr>
                                    <td style="width:50px;"><span class="round"><img src="/dark/images/users/8.jpg" alt="user" width="50"></span></td>
                                    <td>
                                ...
                                <tr class="active">
                                    <td><span class="round"><img src="/dark/images/users/2.jpg" alt="user" width="50"></span></td>
                                    <td>
                                ...
                                <tr>
                                    <td><span class="round round-success"><img src="/dark/images/users/1.jpg" alt="user" width="50"></span></td>
                                    <td>
                                ...
                                <tr>
                                    <td><span class="round round-primary"><img src="/dark/images/users/4.jpg" alt="user" width="50"></span></td>
                                    <td>
                                ...
                                <tr>
                                    <td><span class="round round-warning"><img src="/dark/images/users/5.jpg" alt="user" width="50"></span></td>
                                    <td>
                                ...
                                <tr>
                                    <td><span class="round round-danger"><img src="/dark/images/users/1.jpg" alt="user" width="50"></span></td>
                                    <td>
            ...
            <div class="card">
                ...
                <div class="comment-widgets m-b-20">
                    ...
                    <div class="d-flex flex-row comment-row">
                        <div class="p-2"><span class="round"><img src="/dark/images/users/1.jpg" alt="user" width="50"></span></div>
                    ...
                    <!-- Comment Row -->
                    <div class="d-flex flex-row comment-row ">
                        <div class="p-2"><span class="round"><img src="/dark/images/users/2.jpg" alt="user" width="50"></span></div>
                    ...
                    <!-- Comment Row -->
                    <div class="d-flex flex-row comment-row">
                        <div class="p-2"><span class="round"><img src="/dark/images/users/3.jpg" alt="user" width="50"></span></div>
                        <div class="comment-text w-100">
                    ...
                    <!-- Comment Row -->
                    <div class="d-flex flex-row comment-row">
                        <div class="p-2"><span class="round"><img src="/dark/images/users/4.jpg" alt="user" width="50"></span></div>
                        <div class="comment-text w-100">
                            <h5>James Anderson</h5>
                            <div class="comment-footer">
                                <span class="date">April 14, 2016</span>
                ...
                <div class="card-body">
                    ...
                    <div class="chat-box">
                        ...
                        <ul class="chat-list">
                            <!--chat Row -->
                            <li>
                                <div class="chat-img"><img src="/dark/images/users/1.jpg" alt="user" /></div>
                            ...
                            <!--chat Row -->
                            <li>
                                <div class="chat-img"><img src="/dark/images/users/2.jpg" alt="user" /></div>
                                <div class="chat-content">
                                    <h5>Bianca Doe</h5>
                            ...
                            <li class="reverse">
                                ...
                                <div class="chat-img"><img src="/dark/images/users/5.jpg" alt="user" /></div>
                                <div class="chat-time">10:57 am</div>
                            </li>
                            <!--chat Row -->
                            <li class="reverse">
                            ...
                            <!--chat Row -->
                            <li>
                                <div class="chat-img"><img src="/dark/images/users/3.jpg" alt="user" /></div>
                                <div class="chat-content">
                    ...
                    <div class="to-do-widget m-t-20">
                        ...
                        <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                            <li class="list-group-item" data-role="task">
                                ...
                                <ul class="assignedto">
                                    <li><img src="/dark/images/users/1.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave"></li>
                                    <li><img src="/dark/images/users/2.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica"></li>
                                    <li><img src="/dark/images/users/3.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka"></li>
                                    <li><img src="/dark/images/users/4.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"></li>
                                </ul>
                            </li>
                            <li class="list-group-item" data-role="task">
                                <div class="checkbox checkbox-info">
                            ...
                            <li class="list-group-item" data-role="task">
                                ...
                                <ul class="assignedto">
                                    <li><img src="/dark/images/users/1.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Assign to Steave"></li>
                                    <li><img src="/dark/images/users/2.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Assign to Jessica"></li>
                                    <li><img src="/dark/images/users/4.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Assign to Selina"></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="profiletimeline m-t-40">
                        <div class="sl-item">
                            <div class="sl-left"> <img src="/dark/images/users/1.jpg" alt="user" class="img-circle"> </div>
                            <div class="sl-right">
                                <div><a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                    <p>assign a new task <a href="#"> Design weblayout</a></p>
                                    <div class="row">
                                        <div class="col-lg-3 col-md-6 m-b-20"><img src="/dark/images/big/img1.jpg" alt="user" class="img-responsive radius"></div>
                                        <div class="col-lg-3 col-md-6 m-b-20"><img src="/dark/images/big/img2.jpg" alt="user" class="img-responsive radius"></div>
                                        <div class="col-lg-3 col-md-6 m-b-20"><img src="/dark/images/big/img3.jpg" alt="user" class="img-responsive radius"></div>
                                        <div class="col-lg-3 col-md-6 m-b-20"><img src="/dark/images/big/img4.jpg" alt="user" class="img-responsive radius"></div>
                                    </div>
                        ...
                        <hr>
                        <div class="sl-item">
                            <div class="sl-left"> <img src="/dark/images/users/2.jpg" alt="user" class="img-circle"> </div>
                            <div class="sl-right">
                                <div> <a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                    <div class="m-t-20 row">
                                        <div class="col-md-3 col-xs-12"><img src="/dark/images/big/img1.jpg" alt="user" class="img-responsive radius"></div>
                        ...
                        <hr>
                        <div class="sl-item">
                            <div class="sl-left"> <img src="/dark/images/users/3.jpg" alt="user" class="img-circle"> </div>
                            <div class="sl-right">
                                <div><a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
                        ...
                        <hr>
                        <div class="sl-item">
                            <div class="sl-left"> <img src="/dark/images/users/4.jpg" alt="user" class="img-circle"> </div>
                            <div class="sl-right">
                                <div><a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
        ...
        <div class="col-lg-4 col-xlg-3">
            <!-- Column -->
            <div class="card">
                <img class="card-img-top" src="/dark/images/background/profile-bg.jpg" alt="Card image cap">
                <div class="card-body little-profile text-center">
                    <div class="pro-img"><img src="/dark/images/users/4.jpg" alt="user" /></div>
            ...
            <!-- Column -->
            <div class="card">
                <div class="card-body bg-inverse" style="background: url(/dark/images/background/user-info.jpg) / cover;">
                ...
                <div class="card-body">
                    <div class="message-box contact-box">
                        ...
                        <div class="message-widget contact-widget">
                            <!-- Message -->
                            <a href="#">
                                <div class="user-img"> <img src="/dark/images/users/1.jpg" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
