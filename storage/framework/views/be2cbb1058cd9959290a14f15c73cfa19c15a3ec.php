...
<body class="fix-header fix-sidebar card-no-border">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <button class="btn btn-primary btn-check-order btn-block" data-url="<?php echo e(route('check.fix.order')); ?>">Check Unresolved Order</button>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body form-body">
                                <form class="form-submit row" action="<?php echo e(route('check.order.number')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-submit row" action="<?php echo e(route('check.order.fix')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <div class="col-md-12">
                                        <div class="form-group">
    ...
    <script type="text/javascript" src="/js/fix-order.js?<?php echo e(time()); ?>"></script>
</html><?php /**PATH C:\laragon\www\lokalseller\resources\views/maintenance/fix.blade.php ENDPATH**/ ?>