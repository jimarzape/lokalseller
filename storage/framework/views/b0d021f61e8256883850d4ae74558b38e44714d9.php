<style type="text/css">
	...
	@page  { size: 100mm 150mm lands; }
</style> 

<body>
	<table width="100%" cellpadding="5" borderpadding="0" style="border: 1px solid #000; font-family: sans-serif;">
		<tr>
			<td style="width: 10%">
				<img src="data:image/png;base64, <?php echo base64_encode(QrCode::format('png')->size(75)->errorCorrection('H')
	                        ->generate($order->order_number)); ?> ">
			</td>
			<td style="line-height: 20px">
				<strong class="f20">LOKALDATPH</strong><br>
				<strong class="f15"><?php echo e($order->order_number); ?></strong><br>
				<strong class="f15">Delivery Receipt</strong>
			</td>
		</tr>
		<tr>
				...
				<table width="100%" cellpadding="0" style="padding:3px;border:solid 1px #000000">
					...
					<tr>
						<td colspan="2">
							...
							<strong class="f13">Shipper</strong>
						</td>
						
					</tr>
					<tr>
						<td colspan="2" class="f13">FROM : <?php echo e($sellers->name); ?></td>
					</tr>
					<tr>
						<td colspan="2" class="f13">
							<?php echo e(strtoupper($sellers->street_address.', '.$sellers->brgyDesc.', '.$sellers->citymunDesc.', '.$sellers->provDesc)); ?>

						</td>
					</tr>
					<tr>
						<td class="f13">Items :</td>
						<td style="text-align: right;" class="f13">Shirt(s)</td>
					</tr>
					
					<tr>
						<td class="f13">Mode :</td>
						<td style="text-align: right" class="f13"><strong><?php echo e(strtoupper($order->payment_method)); ?></strong></td>
					</tr>
					<tr>
						<td colspan="2">
							<span class="f13">Payable Amount :</span>
							<span style="float: right;font-weight: bold;" class="f20">PHP&nbsp;<?php echo e(number_format($order->seller_total, 2)); ?></span>
						</td>
					</tr>
					<tr>
						<td colspan="2" class="f11">&nbsp;</td>
		...
		<tr>
			<td colspan="2" style="font-weight: bold" class="f13">
		...
		<tr>
			<td colspan="2" style="text-align: center;font-weight: bold" class="f13">
				www.lokaldatph.com
			</td>
		</tr>
		<tr>
			<td colspan="2" style="text-align: center;color:gray" class="f13">
				Print
			</td>
		</tr>
		<tr>
...
<?php /**PATH C:\laragon\www\lokalseller\resources\views/orders/print.blade.php ENDPATH**/ ?>