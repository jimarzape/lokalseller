<table width="300" cellpadding="5" borderpadding="0" style="border: 1px solid #000; font-family: sans-serif;">
	<tr>
		<td style="width: 10%">
			<img src="data:image/png;base64, <?php echo base64_encode(QrCode::format('png')->size(100)->errorCorrection('H')
                        ->generate($order->order_number)); ?> ">
		</td>
		<td style="line-height: 24px">
			<strong style="font-size: 24px">LOKALDATPH</strong><br>
			<strong style="font-size: 18px"><?php echo e($order->order_number); ?></strong><br>
	...
	<tr>
		<td colspan="2" style="padding:5px;padding-top:10px;padding-bottom: 10px;">
			<table width="100%" cellpadding="0" style="padding:3px;border:solid 1px #000000">
				...
				<tr>
					<td colspan="2">To : <?php echo e($order->userFullName); ?></td>
				</tr>
				<tr>
					<td colspan="2">
						<?php echo e(strtoupper($order->userShippingAddress)); ?>
				...
				<tr>
					<td colspan="2">FROM : <?php echo e($sellers->name); ?></td>
				</tr>
				<tr>
					<td colspan="2">
				...
				<tr>
					<td>Mode :</td>
					<td style="text-align: right"><strong><?php echo e(strtoupper($order->payment_method)); ?></strong></td>
				</tr>
				<tr>
					<td colspan="2">
						Payable Amount :
						<span style="float: right;font-weight: bold;font-size: 24px">PHP&nbsp;<?php echo e(number_format($order->order_amount_due, 2)); ?></span>
					</td>
				</tr>
				<tr>
					<td colspan="2">&nbsp;</td>
...
</table><?php /**PATH C:\laragon\www\lokalseller\resources\views/orders/print.blade.php ENDPATH**/ ?>